        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-border-color card-border-color-primary">
                  <div class="card-header card-header-divider">Edit Class<span class="card-subtitle"></span></div>
                    @if (session('success'))
                    ...
                    @endif
                  <div class="card-body">
                    <form action="{{ route('admin.class.edit',encrypt($data->id)) }}" method="POST" id="people_add_form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

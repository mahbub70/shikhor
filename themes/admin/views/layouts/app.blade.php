        ...
        <div class="container-fluid">
          ...
          <div class="be-right-navbar">
            <ul class="nav navbar-nav float-right be-user-nav">
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><img src="{{ asset('themes/admin/img/users/') }}/{{ Auth::guard('admin')->user()->image }}" alt="Avatar"><span class="user-name">{{ Auth::guard('admin')->user()->name }}</span></a>
            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span>Class Videos</span></a>
                    <ul class="sub-menu">
                      <li class="{{ ((Route::currentRouteName() == "admin.all-videos")?'active':'') }}"><a href="{{ route('admin.all-videos') }}">All Videos</a>
                      </li>
                      <li><a href="">Free Classes</a>
                      </li>
